...
The goal is to create a docker image for deployment of the api. This way the api could be deployed on cloud or locally by the user with ease. I will also include docker-compose file for the API.
